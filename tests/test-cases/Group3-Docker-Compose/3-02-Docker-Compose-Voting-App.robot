...
Compose Voting App
    ...
    ${rc}  ${out}=  Run And Return Rc And Output  docker-compose --skip-hostname-check -f %{GOPATH}/src/github.com/vmware/vic/demos/compose/voting-app/docker-compose.yml ${params} up -d
    Log  ${out}
    #Log  ${out.stdout}
    #Log  ${out.stderr}
    Should Be Equal As Integers  ${rc}  0
