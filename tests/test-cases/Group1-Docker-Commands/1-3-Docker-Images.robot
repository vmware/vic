...
Simple images
    ...
    ${rc}  ${output}=  Run And Return Rc And Output  docker ${params} pull alpine:3.2
    Should Be Equal As Integers  ${rc}  0
    Should Not Contain  ${output}  Error
    ${rc}  ${output}=  Run And Return Rc And Output  docker ${params} pull alpine:3.1
    Should Be Equal As Integers  ${rc}  0
    Should Not Contain  ${output}  Error
...
All images
    ${rc}  ${output}=  Run And Return Rc And Output  docker ${params} images -a
    Should Be Equal As Integers  ${rc}  0
    Should Not Contain  ${output}  Error
    Should Contain X Times  ${output}  alpine  3

Quiet images
    ${rc}  ${output}=  Run And Return Rc And Output  docker ${params} images -q
    Should Be Equal As Integers  ${rc}  0
    Should Not Contain  ${output}  Error
...
No-trunc images
    ${rc}  ${output}=  Run And Return Rc And Output  docker ${params} images --no-trunc
    Should Be Equal As Integers  ${rc}  0
    Should Not Contain  ${output}  Error
    Should Contain X Times  ${output}  alpine  3
    @{lines}=  Split To Lines  ${output}
...
#    ${rc}  ${output}=  Run And Return Rc And Output  docker ${params} images alpine:3.1
#    Should Be Equal As Integers  ${rc}  0
#    Should Not Contain  ${output}  Error
