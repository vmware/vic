...
2. Pull busybox image and create a container named online
...
14. Remove online
15. Create a container called online with a single volume attached to it
16. Start online and issue docker cp ./bar online:/vol1/ to the new VIC appliance
...
28. Remove online
29. Clean up created files, directories and volumes
