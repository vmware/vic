...
* [Installing the vSphere Client Plug-ins](install_vic_plugin.md)
  ...
  * [Install the HTML5 Plug-In on vCenter Server for Windows](plugin_h5_vc_web.md)
  * [vCenter Server for Windows by Using a Web Server](plugin_vc_web.md)
  * [vCenter Server for Windows Without Access to a Web Server](plugin_vc_no_web.md)
