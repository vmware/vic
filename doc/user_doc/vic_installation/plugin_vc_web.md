...
If your vCenter Server instance runs on Windows, you can use a Web server to host the Flex-based vSphere Web Client plug-in for vSphere Integrated Containers Engine.
...
2. Upload the plug-in bundle to your Web server.
    <pre><i>unpack_dir</i>\vic\ui\vsphere-client-serenity\com.vmware.vic-<i>version</i>.zip</pre>
