...
type Process struct {
	...
	Start func(context.Context, *VixMsgStartProgramRequest) (int64, error)
	Wait  func() error
...
func (m *ProcessManager) Start(r *VixMsgStartProgramRequest, p *Process) (int64, error) {
...
func (f *processFunc) start(ctx context.Context, r *VixMsgStartProgramRequest) (int64, error) {
	f.wg.Add(1)
...
func (c *processCmd) start(ctx context.Context, r *VixMsgStartProgramRequest) (int64, error) {
