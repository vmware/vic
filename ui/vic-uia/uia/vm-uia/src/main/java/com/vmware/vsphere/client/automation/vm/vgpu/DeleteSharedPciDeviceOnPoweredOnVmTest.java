...
import com.vmware.vsphere.client.automation.vm.vgpu.step.VerifyDeleteBtnForSharedPciDeviceStep;
 ...
 * 6. Edit VM - add new Shared PCI Device
 * 7. Power on VM > Verify Delete for Shared PCI Device is disabled
 */
public class DeleteSharedPciDeviceOnPoweredOnVmTest extends NGCTestWorkflow {
   ...
   public void composeTestSteps(
      ...
      flow.appendStep("Verify Delete for Shared Pci Device is disabled",
            new VerifyDeleteBtnForSharedPciDeviceStep());
   ...
   @Override
   @Test(description = "Verify that vGPU device can not be deleted on Powered On VM.")
   @TestID(id = "616775")
