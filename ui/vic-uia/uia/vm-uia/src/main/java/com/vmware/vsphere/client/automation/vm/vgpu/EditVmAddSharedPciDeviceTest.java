 ...
 * 7. Verify warning, note labels and Reserve All Memory buttons appear
 * 8. Verify via UI that the Shared PCI Device has been added
 * 9. Power on VM > verify task succeeds
 */
public class EditVmAddSharedPciDeviceTest extends NGCTestWorkflow {
   ...
   @Override
   @Test(description = "Edit VM > Add Shared PCI Device and power on vm.")
   @TestID(id = "616771")
