...
import com.vmware.vsphere.client.automation.vm.vgpu.step.DeleteSharedPciDeviceStep;
import com.vmware.vsphere.client.automation.vm.vgpu.step.VerifySharedPciDeviceDeletedStep;
 ...
 * 6. Edit VM - add new Shared PCI Device > Click Ok
 * 7. Launch Edit Vm Settings > Click Remove for added Shared Pci Device
 * 8. Verify Shared Pci can be deleted for powered off vm
 */
public class DeleteSharedPciDeviceOnPoweredOffVmTest extends NGCTestWorkflow {
   ...
   public void composeTestSteps(
      ...
      flow.appendStep("Add new Shared PCI Device for the VM",
      ...
      flow.appendStep("Verify Delete for Shared Pci Device succeeds",
            new DeleteSharedPciDeviceStep());
      ...
      flow.appendStep("Verify Shared Pci Device is deleted",
            new VerifySharedPciDeviceDeletedStep());
   }

   @Override
   @Test(description = "Verify that vGPU device can be deleted on Powered Off VM.")
   @TestID(id = "616769")
