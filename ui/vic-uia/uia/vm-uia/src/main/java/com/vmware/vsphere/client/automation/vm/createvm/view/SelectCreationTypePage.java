...
import com.vmware.vsphere.client.automation.vm.createvm.spec.CreateVmSpec.VmCreationType;

/**
 * Select creation type for the VM
 *
 * @deprecated  Replaced by
 *    {@link com.vmware.vsphere.client.automation.vm.lib.createvm.view.SelectCreationTypePage}}
 */
@Deprecated
public class SelectCreationTypePage extends WizardNavigator {
    private static final String VM_CREATION_LIST = "optionsList";
    private static String PAGE_TITLE = VmUtil.getLocalizedString("createVm.wizard.creationTypePage.title");
