...
func (c *ContainerBackend) containerCreate(op trace.Operation, vc *viccontainer.VicContainer, config types.ContainerCreateConfig) (string, error) {
	...
	h, err = c.containerProxy.AddImageToContainer(op, h, "hacked-in-alpine", "9797e5e798a034d53525968de25bd25c913e7bb17c6d068ebc778cb33e3ff6e5", "3fd9065eaf02feaf94d68376da52541925650b81698c53c6824d92ff63f98353", config)
	if err != nil {
		return "", err
	}
