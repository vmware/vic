...
func (o *GetContainerLogsNotFound) Error() string {
	return fmt.Sprintf("[GET /containers/{id}/logs][%d] getContainerLogsNotFound  %+v", 404, o.Payload)
}
...
func (o *GetContainerLogsInternalServerError) Error() string {
	return fmt.Sprintf("[GET /containers/{id}/logs][%d] getContainerLogsInternalServerError  %+v", 500, o.Payload)
}
