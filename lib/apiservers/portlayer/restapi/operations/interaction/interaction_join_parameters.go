...
// InteractionJoinParams contains all the bound params for the interaction join operation
// typically these are obtained from a http.Request
//
// swagger:parameters InteractionJoin
...
func (o *InteractionJoinParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r

	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.InteractionJoinConfig
