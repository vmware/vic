...
// LoggingBindParams contains all the bound params for the logging bind operation
// typically these are obtained from a http.Request
//
// swagger:parameters LoggingBind
...
func (o *LoggingBindParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r

	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.LoggingBindConfig
