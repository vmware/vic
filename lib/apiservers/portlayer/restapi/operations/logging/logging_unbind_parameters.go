...
// LoggingUnbindParams contains all the bound params for the logging unbind operation
// typically these are obtained from a http.Request
//
// swagger:parameters LoggingUnbind
...
func (o *LoggingUnbindParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r

	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.LoggingUnbindConfig
